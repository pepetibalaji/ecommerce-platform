...
public class PaymentSuccessEvent extends AbstractDomainEvent {
  ...
  public PaymentSuccessEvent() {
    super(EventTypes.PAYMENT_SUCCESS, EventSources.PAYMENT_SERVICE, null, null);
  }
  ...
  public PaymentSuccessEvent(
      ...
      String traceId) {
    super(EventTypes.PAYMENT_SUCCESS, EventSources.PAYMENT_SERVICE, correlationId, traceId);
