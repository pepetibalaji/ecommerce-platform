...
public class InventoryReleasedEvent extends AbstractDomainEvent {
  ...
  public InventoryReleasedEvent() {
    super(EventTypes.INVENTORY_RELEASED, EventSources.INVENTORY_SERVICE, null, null);
  }
  ...
  public InventoryReleasedEvent(
      ...
      String traceId) {
    super(EventTypes.INVENTORY_RELEASED, EventSources.INVENTORY_SERVICE, correlationId, traceId);
