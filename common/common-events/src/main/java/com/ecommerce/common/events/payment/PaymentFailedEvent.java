...
public class PaymentFailedEvent extends AbstractDomainEvent {
  ...
  public PaymentFailedEvent() {
    super(EventTypes.PAYMENT_FAILED, EventSources.PAYMENT_SERVICE, null, null);
  }
  ...
  public PaymentFailedEvent(
      ...
      String traceId) {
    super(EventTypes.PAYMENT_FAILED, EventSources.PAYMENT_SERVICE, correlationId, traceId);
