...
| [Events and operations](events-and-operations.md) | Kafka/product snapshot reconciliation, outbox, metrics, configuration, and recovery. |
| [Current implementation](current-implementation.md) | Production behavior, deployment inputs, and known verification follow-up. |
