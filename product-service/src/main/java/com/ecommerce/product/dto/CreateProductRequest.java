...
public class CreateProductRequest {
    ...
    public CreateProductRequest(String name, String description, BigDecimal price, String category, String brand, List<String> imageUrls) {
        this.name = name; this.description = description; this.price = price; this.category = category; this.brand = brand; this.currency = "USD"; this.imageUrls = imageUrls;
    }
